<section class="lum-container relative bg-lum-ivory">
    ...
    <div class="relative h-[1466px] tab:hidden">
        ...
        <a href="{{ \App\Support\Site::mapUrl() }}" target="_blank" rel="noopener noreferrer" class="lum-btn-green absolute left-[109px] top-[642px] px-[24px] py-[5px] text-[14px] font-extrabold uppercase leading-[23px] tracking-[2.84px] whitespace-nowrap" data-lum-scroll-reveal>{{ strtoupper($contact['see_on_map']) }}</a>
    ...
    <div class="relative hidden h-[1310px] tab:block desk:hidden">
        ...
        <a href="{{ \App\Support\Site::mapUrl() }}" target="_blank" rel="noopener noreferrer" class="lum-btn-green absolute left-[638px] top-[564px] px-[24px] py-[5px] text-[14px] font-extrabold uppercase leading-[23px] tracking-[2.84px] whitespace-nowrap" data-lum-scroll-reveal>{{ strtoupper($contact['see_on_map']) }}</a>
        ...
        <div class="absolute left-1/2 top-[904px] flex -translate-x-1/2 gap-[10px]" data-lum-scroll-reveal>
            @include('lum.partials.footer-social', ['img' => $img, 'network' => 'instagram', 'tone' => 'light', 'href' => \App\Support\Site::instagramUrl()])
            @include('lum.partials.footer-social', ['img' => $img, 'network' => 'whatsapp', 'tone' => 'light', 'href' => \App\Support\Site::whatsappUrl()])
        </div>
    ...
    <div class="relative hidden desk:block" data-lum-villa-intro>
        ...
        <a href="{{ \App\Support\Site::mapUrl() }}" target="_blank" rel="noopener noreferrer" class="lum-btn-green absolute left-[1550px] top-[844px] px-[34px] pt-[6px] pb-[5px] text-[16px] font-extrabold uppercase leading-[25px] tracking-[3.2px] whitespace-nowrap" data-lum-stay-intro-item data-lum-stay-intro-order="16">{{ strtoupper($contact['see_on_map']) }}</a>
