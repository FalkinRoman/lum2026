...
<section class="lum-container relative overflow-visible bg-lum-ivory h-[980px] tab:h-[1403px] desk:h-[1890px] desk:w-[1920px]" data-lum-villa-panel>
    ...
    <div class="relative h-full tab:hidden">
        ...
        <p class="absolute left-[43px] top-[748px] w-[290px] text-center text-[14px] leading-[22px] tracking-[0.1px] text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $activity['gallery']['body_bottom'] }}</p>
    ...
    <div class="relative hidden h-full tab:block desk:hidden">
        ...
        <p class="absolute left-1/2 top-[1184px] w-[560px] -translate-x-1/2 text-center lum-text-2 text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $activity['gallery']['body_bottom'] }}</p>
    ...
    <div class="relative hidden h-full desk:block">
        ...
        <p class="absolute left-1/2 top-[1630px] w-[856px] -translate-x-1/2 text-center lum-body text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $activity['gallery']['body_bottom'] }}</p>
