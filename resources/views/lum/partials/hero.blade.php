<section class="lum-container relative h-[680px] tab:h-[1080px] desk:h-[1242px] bg-lum-cream">
    ...
    <div class="relative h-[680px] tab:hidden">
        ...
        <div class="absolute bottom-[80px] left-[20px] flex w-[335px] flex-col items-center gap-[36px]">
            ...
            <a href="{{ route('stay') }}" class="lum-btn-green px-[24px] pt-[5px] pb-[4px] text-[14px] leading-[23px] tracking-[2.84px]" data-lum-sticky-trigger>{{ __('lum.hero.cta') }}</a>
        </div>
    ...
    <div class="relative hidden h-[1242px] desk:block">
        ...
        <a href="{{ route('stay') }}" class="lum-btn-green absolute left-1/2 top-[1018px] z-20 -translate-x-1/2" data-lum-sticky-trigger>{{ __('lum.hero.cta') }}</a>
