@php
    $cmsPolaroids = $villa['gallery']['polaroids'] ?? [];
    $pick = function (int $i, string $fallbackPhoto, string $fallbackDate) use ($cmsPolaroids): array {
    ...
    $galleryPolaroids = [
        'mob' => [
            ['left' => '20px', 'top' => '430px', 'rotate' => '8deg', 'fw' => 160, 'fh' => 226, 'px' => 13, 'py' => 21, 'pw' => 133, 'ph' => 141, 'dateSize' => 10, 'shareSize' => 9, 'dateTop' => 8, 'shareBottom' => 22, 'path' => $p0['path'], 'date' => $p0['date']],
            ['left' => '195px', 'top' => '430px', 'rotate' => '-6deg', 'fw' => 160, 'fh' => 226, 'px' => 13, 'py' => 21, 'pw' => 133, 'ph' => 141, 'dateSize' => 10, 'shareSize' => 9, 'dateTop' => 8, 'shareBottom' => 22, 'path' => $p1['path'], 'date' => $p1['date']],
        ],
        'tab' => [
            ['left' => '20px', 'top' => '385px', 'rotate' => '6deg', 'fw' => 450, 'fh' => 635, 'px' => 37, 'py' => 59, 'pw' => 374, 'ph' => 418, 'dateSize' => 13, 'shareSize' => 17, 'dateTop' => 34, 'shareBottom' => 92, 'path' => $p0['path'], 'date' => $p0['date']],
            ['left' => '490px', 'top' => '385px', 'rotate' => '-4deg', 'fw' => 450, 'fh' => 635, 'px' => 37, 'py' => 59, 'pw' => 374, 'ph' => 418, 'dateSize' => 13, 'shareSize' => 17, 'dateTop' => 34, 'shareBottom' => 92, 'path' => $p1['path'], 'date' => $p1['date']],
        ],
        'desk' => [
            ['left' => '72px', 'top' => '560px', 'rotate' => '5deg', 'fw' => 549, 'fh' => 775, 'px' => 45, 'py' => 72, 'pw' => 456, 'ph' => 509, 'dateSize' => 16, 'shareSize' => 23, 'dateTop' => 42, 'shareBottom' => 106, 'path' => $p0['path'], 'date' => $p0['date']],
            ['left' => '685px', 'top' => '560px', 'rotate' => '-3deg', 'fw' => 549, 'fh' => 775, 'px' => 45, 'py' => 72, 'pw' => 456, 'ph' => 509, 'dateSize' => 16, 'shareSize' => 23, 'dateTop' => 42, 'shareBottom' => 106, 'path' => $p1['path'], 'date' => $p1['date']],
            ['left' => '1299px', 'top' => '560px', 'rotate' => '7deg', 'fw' => 549, 'fh' => 775, 'px' => 45, 'py' => 72, 'pw' => 456, 'ph' => 509, 'dateSize' => 16, 'shareSize' => 23, 'dateTop' => 42, 'shareBottom' => 106, 'path' => $p2['path'], 'date' => $p2['date']],
        ],
    ];
@endphp
