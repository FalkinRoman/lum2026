@php
    ...
    $polaroidPhotos = collect([0, 1, 2])->map(function (int $i) use ($polaroidPhotosRaw) {
        ...
        return str_starts_with($raw, 'polaroids/') ? $raw : 'polaroids/'.$raw;
    })->all();
    $polaroidsCta = $polaroids['cta'] ?? __('lum.hero.cta');
    $polaroidsCtaHref = \App\Support\Content::link($polaroids['cta_url'] ?? null);
@endphp
<section class="lum-container relative isolate h-[1173px] overflow-visible bg-lum-ivory tab:h-[1134px] desk:h-[1299px]">
    ...
    <div class="relative z-20 h-full tab:hidden" data-lum-scroll-stagger>
        @foreach ([
            ['left' => '59.07px', 'top' => '107.45px', 'rotate' => '13.51deg', 'fw' => '153px', 'fh' => '229px', 'photo' => $polaroidPhotos[0], 'date' => '06.08.2023', 'script' => '14px'],
            ['left' => '198.36px', 'top' => '156px', 'rotate' => '-0.97deg', 'fw' => '153px', 'fh' => '229px', 'photo' => $polaroidPhotos[1], 'date' => '06.01.2024', 'script' => '14px'],
            ['left' => '91px', 'top' => '852.55px', 'rotate' => '-9.98deg', 'fw' => '153px', 'fh' => '229px', 'photo' => $polaroidPhotos[2], 'date' => '07.03.2023', 'script' => '14px'],
        ] as $polaroid)
            <div class="absolute z-20" style="left: {{ $polaroid['left'] }}; top: {{ $polaroid['top'] }}; transform: rotate({{ $polaroid['rotate'] }});">
                <div class="relative" data-lum-scroll-item style="width: {{ $polaroid['fw'] }}; height: {{ $polaroid['fh'] }};">
                    ...
                    <img src="{{ \App\Support\Content::mediaUrl($polaroid['photo']) }}" alt="" class="lum-polaroid__photo">
        ...
        <div class="absolute left-[20px] top-[450px] flex w-[335px] flex-col items-center gap-[44px]" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.2">
            ...
            <a href="{{ $polaroidsCtaHref }}" class="lum-btn-dark px-[24px] pt-[5px] pb-[4px] text-[14px] leading-[23px] tracking-[2.84px]">{{ $polaroidsCta }}</a>
        </div>
    ...
    <div class="relative z-20 hidden h-full tab:block desk:hidden" data-lum-scroll-stagger>
        @foreach ([
            ['left' => '108.77px', 'top' => '147.56px', 'rotate' => '13.51deg', 'fw' => '251px', 'fh' => '375px', 'photo' => $polaroidPhotos[0], 'date' => '06.08.2023', 'script' => '18px'],
            ['left' => '654.73px', 'top' => '138px', 'rotate' => '-0.97deg', 'fw' => '251px', 'fh' => '375px', 'photo' => $polaroidPhotos[1], 'date' => '06.01.2024', 'script' => '18px'],
            ['left' => '380px', 'top' => '184.2px', 'rotate' => '-9.98deg', 'fw' => '251px', 'fh' => '375px', 'photo' => $polaroidPhotos[2], 'date' => '07.03.2023', 'script' => '18px'],
        ] as $polaroid)
            <div class="absolute z-20" style="left: {{ $polaroid['left'] }}; top: {{ $polaroid['top'] }}; transform: rotate({{ $polaroid['rotate'] }});">
                <div class="relative" data-lum-scroll-item style="width: {{ $polaroid['fw'] }}; height: {{ $polaroid['fh'] }};">
                    <img src="{{ $img('polaroids/frame.svg') }}" alt="" class="lum-polaroid__frame drop-shadow-[1px_1px_0_rgba(0,0,0,0.25)]" width="271" height="405">
    ...
    <div class="relative z-20 hidden h-full desk:block" data-lum-scroll-stagger>
        @foreach ([
            ['left' => '216px', 'top' => '362px', 'rotate' => '13.5deg', 'photo' => $polaroidPhotos[0], 'date' => '06.08.2023'],
            ['left' => '787px', 'top' => '109px', 'rotate' => '-5.5deg', 'photo' => $polaroidPhotos[1], 'date' => '06.01.2024'],
            ['left' => '1463px', 'top' => '392px', 'rotate' => '-1deg', 'photo' => $polaroidPhotos[2], 'date' => '07.03.2023'],
        ] as $polaroid)
        ...
        <div class="absolute left-[532px] top-[693px] flex w-[856px] flex-col items-center gap-[64px]" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.2">
            ...
            <a href="{{ $polaroidsCtaHref }}" class="lum-btn-dark">{{ $polaroidsCta }}</a>
        </div>
