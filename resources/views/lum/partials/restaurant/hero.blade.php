...
<section class="lum-container relative z-[1] overflow-visible h-[680px] tab:h-[1080px] desk:h-[1080px]">
    {{-- MOBILE — Figma 186:675; oval 186:741 at gallery y=-144 → hero top 536 --}}
    <div class="relative h-full overflow-visible tab:hidden" data-lum-villa-panel>
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ $img($heroImage) }}" alt="" class="h-full w-full object-cover object-center" width="375" height="680" loading="eager">
        ...
        <div class="absolute left-[20px] top-[208px] flex w-[335px] flex-col items-center gap-[30px]" data-lum-villa-intro>
            ...
            <div class="flex w-full flex-col items-center gap-[24px]">
                <p class="text-center text-[14px] font-medium uppercase leading-[14px] tracking-[0.6px] text-lum-ivory" data-lum-stay-intro-item data-lum-stay-intro-order="2">{{ $restaurant['hero']['eyebrow'] }}</p>
                <h1 class="lum-hero-title text-center text-lum-ivory" data-lum-hero-title>
                    @if ($restaurant['hero']['title_normal'] !== '')
                        <span class="lum-hero-title__line block">
                            <span class="lum-hero-title__text block font-serif text-[52px] leading-[55px]" data-lum-stay-intro-item data-lum-stay-intro-order="3">{{ $restaurant['hero']['title_normal'] }}</span>
                        </span>
                    @endif
                    <span class="lum-hero-title__line block">
                        <span class="lum-hero-title__text block font-serif text-[52px] font-medium italic leading-[55px]" data-lum-stay-intro-item data-lum-stay-intro-order="4">{{ $restaurant['hero']['title_italic'] }}</span>
                    </span>
                </h1>
            </div>
        </div>
    ...
    {{-- TABLET — Figma 186:529; oval dropped lower per visual (was 796) --}}
    <div class="relative hidden h-full overflow-visible tab:block desk:hidden" data-lum-villa-panel>
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ $img($heroImage) }}" alt="" class="h-full w-full object-cover object-center" width="960" height="1080" loading="eager">
            <div class="absolute inset-0 bg-black/48"></div>
        </div>
        ...
        <div class="absolute left-[20px] top-[449px] flex w-[920px] flex-col items-center gap-[30px]" data-lum-villa-intro>
            ...
            <div class="flex w-full flex-col items-center gap-[24px]">
                <p class="text-center text-[16px] font-medium leading-[25px] tracking-[0.16px] text-lum-ivory" data-lum-stay-intro-item data-lum-stay-intro-order="2">{{ $restaurant['hero']['eyebrow'] }}</p>
                <h1 class="lum-hero-title whitespace-nowrap text-center text-lum-ivory" data-lum-hero-title>
                    @if ($restaurant['hero']['title_normal'] !== '')
                        <span class="lum-hero-title__line lum-hero-title__line--inline">
                            <span class="lum-hero-title__text font-serif text-[64px] leading-[64px]" data-lum-stay-intro-item data-lum-stay-intro-order="3">{{ $restaurant['hero']['title_normal'] }}</span>
                        </span>
                    @endif
                    <span class="lum-hero-title__line lum-hero-title__line--inline">
                        <span class="lum-hero-title__text font-serif text-[64px] font-medium italic leading-[64px]" data-lum-stay-intro-item data-lum-stay-intro-order="4">{{ $restaurant['hero']['title_italic'] }}</span>
                    </span>
                </h1>
            </div>
        </div>
    ...
    {{-- DESKTOP — Figma 186:367; oval 770; torn-edge overlaps photo (not below clip) --}}
    <div class="relative hidden h-full overflow-visible desk:block" data-lum-villa-panel>
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ $img($heroImage) }}" alt="" class="h-full w-full object-cover object-center" width="1920" height="1080" loading="eager">
            <div class="absolute inset-0 bg-black/48"></div>
        </div>
        ...
        <div class="absolute left-[80px] top-[398px] flex w-[1760px] flex-col items-center gap-[44px]" data-lum-villa-intro>
            ...
            <div class="flex w-full flex-col items-center gap-[38px]">
                <p class="lum-eyebrow text-center text-lum-ivory" data-lum-stay-intro-item data-lum-stay-intro-order="2">{{ $restaurant['hero']['eyebrow'] }}</p>
                <div class="flex w-full items-center justify-center gap-[32px]">
                    ...
                    <h1 class="lum-hero-title whitespace-nowrap text-center text-lum-ivory" data-lum-hero-title>
                        @if ($restaurant['hero']['title_normal'] !== '')
                            <span class="lum-hero-title__line lum-hero-title__line--inline">
                                <span class="lum-hero-title__text font-serif text-[120px] leading-[120px] tracking-[-1.16px]" data-lum-stay-intro-item data-lum-stay-intro-order="3">{{ $restaurant['hero']['title_normal'] }}</span>
                            </span>
                        @endif
                        <span class="lum-hero-title__line lum-hero-title__line--inline">
                            <span class="lum-hero-title__text font-serif text-[120px] font-medium italic leading-[120px] tracking-[-1.16px]" data-lum-stay-intro-item data-lum-stay-intro-order="4">{{ $restaurant['hero']['title_italic'] }}</span>
                        </span>
                    </h1>
