...
<section class="lum-container relative bg-lum-ivory h-[980px] tab:h-[1403px] desk:h-[1890px] desk:w-[1920px]" data-lum-villa-panel>
    <div class="pointer-events-none absolute left-1/2 z-[20] h-[188px] w-[140px] -translate-x-1/2 overflow-hidden rounded-[50%] tab:hidden" style="top: -144px">
        <img src="{{ $img($assetBase . '/oval.webp') }}" alt="" class="h-full w-full object-cover" width="140" height="188">
    </div>
    <div class="pointer-events-none absolute left-1/2 z-[20] hidden h-[430px] w-[320px] -translate-x-1/2 overflow-hidden rounded-[50%] desk:block" style="top: -310px">
    ...
    <div class="relative h-full tab:hidden">
        <p class="lum-script absolute inset-x-0 top-[60px] whitespace-nowrap text-center text-[24px] leading-none tracking-[1.2px] text-lum-espresso" data-lum-villa-eyebrow>{{ $restaurant['gallery']['eyebrow'] }}</p>
        ...
        <p class="absolute left-[20px] top-[720px] w-[335px] text-center text-[14px] leading-[22px] tracking-[0.1px] text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $restaurant['gallery']['body_bottom'] }}</p>
    ...
    <div class="relative hidden h-full tab:block desk:hidden">
        <p class="lum-script absolute inset-x-0 top-0 whitespace-nowrap text-center text-[28px] leading-none tracking-[1.4px] text-lum-espresso" data-lum-villa-eyebrow>{{ $restaurant['gallery']['eyebrow'] }}</p>
        ...
        <p class="absolute left-1/2 top-[1140px] w-[560px] -translate-x-1/2 text-center lum-text-2 text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $restaurant['gallery']['body_bottom'] }}</p>
    ...
    <div class="relative hidden h-full desk:block">
        <p class="lum-script absolute inset-x-0 top-[105px] whitespace-nowrap text-center text-[32px] leading-none tracking-[1.6px] text-lum-espresso" data-lum-villa-eyebrow>{{ $restaurant['gallery']['eyebrow'] }}</p>
        ...
        <p class="absolute left-1/2 top-[1495px] w-[856px] -translate-x-1/2 text-center lum-body text-lum-espresso" data-lum-scroll-reveal data-lum-scroll-reveal-delay="0.1">{{ $restaurant['gallery']['body_bottom'] }}</p>
