        ...
        foreach ($enProperties as $index => $enProperty) {
            ...
            $this->setTranslations($villa, [
                ...
                'facilities_left' => $this->i18n(
                    $enFacilities['items'] ?? array_merge($enFacilities['items_left'] ?? [], $enFacilities['items_right'] ?? []),
                    $ruFacilities['items'] ?? array_merge($ruFacilities['items_left'] ?? [], $ruFacilities['items_right'] ?? []),
                    $zhFacilities['items'] ?? array_merge($zhFacilities['items_left'] ?? [], $zhFacilities['items_right'] ?? []),
                ),
